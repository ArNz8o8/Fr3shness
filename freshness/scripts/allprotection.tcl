...
set logkbs(file) "logs/protection_logs.log"
...
set btclocked(lnotc) "Channel has been locked due to flood, It should come back as normal soon. Please wait."
...
set textl(klmsg) "Text flooding is not permissable on this channel."
...
lappend ap:udefs {ap:textc "300:3 120 w:k:kb 2"}
...
set textc(klmsg) "Text flooding (chars) is not permissable on this channel."
...
lappend ap:udefs {ap:notcl "1:3 20 w:k:kb 2"}
...
set notcl(klmsg) "Notice flooding is not permissable on this channel."
...
lappend ap:udefs {ap:notcc "200:3 180 w:kb 2"}
...
set notcc(klmsg) "Notice flooding (chars) is not permissable on this channel."
...
# Set default rate here:
lappend ap:udefs {ap:caps "60:90 120 w:kb 2"}
...
set capsp(klmsg) "Caps flooding is not permissable on this channel."
...
lappend ap:udefs {ap:repeatl "5:10 60 w:k:kb 2"}
...
set repeatf(lkmsg) "Letter repeats detected, do not use excess consecutive letters. THIS!!!!!!! :))))))) is annoying $kckcount(form)"
...
set repeatf(klmsg) "Constant repeating is not permissable on this channel."
...
set codesf(klmsg) "Excess use of control codes is not permissable on this channel."
...
set adexempts(global) { %chan holland-stats.8o8networkz.tk }
...
set antispam(host) masteruk.xshellz.com
...
set antispam(greet) "Hello %nick, i am a bot, checking for spam. Please do not reply. If you want just /ignore me. Bonjour, je suis un robot, je surveille pour le spam. NE REPONDEZ PAS! Vous pouvez tapé /ignore <mon nick>"
...
set adv(klmsg) "Constant advertising is not permissable on this channel."
...
lappend ap:udefs {ap:swear "+ 120 w:k:kb 2"}
...
set swear(klmsg) "Swearing is not permissable on this channel."
...
set ctcpf(klmsg) "CTCP/CTCR floods are not permissable on this channel."
...
set massdeop(klmsg) "Mass deops are not allowed on this channel."
...
set masskick(klmsg) "Mass kicks are prohibited on this channel."
...
set massb(klmsg) "Mass banning (bans) is prohibited on this channel."
...
lappend ap:udefs {ap:cjoin "10:2 120 kb 2"}
...
set joinflood(lockmode) "r-k flood.join.temp.key"
...
set joinflood(wmsg) "Warning: you've triggered join flood protection, further offence will cause harsher actions. And reports will be sent to your ISP"

## Edit the following only if you choose a punish method above 5 (oper commands):

set joinflood(ktype) 2

set joinflood(klmsg) "Join floods are not permissable on this channel."
...
set pmsgf(klmsg) "Part msg floods are not permissable on this channel."
...
# Set default value here:
lappend ap:udefs {ap:revdoor "10 120 w:kb 2"}
...
set revdoor(klmsg) "Revolving-door bots are not allowed on this channel."
...
lappend ap:udefs {ap:nickf "2:60 60 w:k:kb 2"}

set nickflood(kmsg) "Nick flood detected. $kckcount(form)"

set nickflood(wmsg) "Warning: You've triggered nick flood protection, slow down your nick changes, or decide allready!"

## Edit the following only if you choose a punish method above 5 (oper commands):

set nickflood(ktype) 2

set nickflood(klmsg) "Nick floods are not permissable on this channel."
...
# Set default value here:
lappend ap:udefs {ap:clones "3 120 k:kb 2"}
...
set eclones(klmsg) "Excess clones are not allowed on this channel."
...
set bnick(klmsg) "Bad nicks are not allowed on this channel."
...
set drone(klmsg) "Random drones are not allowed on this channel."
...
set bident(klmsg) "Bad idents are not allowed on this channel."
...
set bchans(global) { #edad* #mp3passion #wh #whitehat #aol #username }
...
set bchan(klmsg) "Joining bad channels is prohibited on this channel."
...
set bctcr(klmsg) "Using bad scripts is prohibited on this channel."
...
proc load {{b bind}} {
 ...
 if {$b == "bind"} {
  ...
  putlog "\002A\002ll\002P\002rotection v4.7 by Opposing (Edited for fr3Sh - Eggdrop 1.8) Loaded..."
 }
}
...
set antispam(next) -1
set antispam(tip) 127.0.0.1
set antispam(thost) masteruk.xshellz.com
