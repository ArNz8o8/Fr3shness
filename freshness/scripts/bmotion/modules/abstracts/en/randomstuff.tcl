...
bMotion_abstract_batchadd "randomStuff" {
	...
	"So do you want some coffee, or would you just prefer a beer?"
	...
	"ha ha i don't live in norwich anymore, i don't eat pigs anymore "
	...
	"pfft might as well enjoy myself, it's the only way I'll get any this side of the 22nd century"
...
bMotion_abstract_register "activeRandomStuff" {
	...
	"push the stinky dribbling back into the sea"
